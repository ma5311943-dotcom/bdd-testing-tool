      ...
      <div className="portal-main">
        ...
        <div className="portal-hero hero-content">
          ...
          <p className="hero-description">
            Experience deep-level behavioral analysis and systemic compliance
            audits. Map your web architecture with our proprietary BDD engine.
          </p>
        ...
        <div className="portal-features">
          <div className="features-matrix">
            {[
              ...
              <div key={i} className="matrix-node glass">
